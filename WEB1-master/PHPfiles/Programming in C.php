...
<body>
   <?php   
     include('header.php');
    ?>  
   <h4 id="subject-heading" >Programming in C</h4>
  ...
  <form id="theory"> <p> Find detailed and comprehensive course for developing your basic understanding of the subject.<br><br> Let&apos;s go!
         ...
         <li><a href="../Documents/ProgramminginCTheory.doc">Click here to download.</a></li>
         </form>
...
<br><br>Let&apos;s go! 
         ...
         <li><a href="../Documents/ProgramminginCPractical.doc">Click here to download.</a></li>
       </form> </div>
