...
<body>
   <?php   
     include('header.php');
    ?>
   <h4 id="subject-heading" >System Development for Software</h4>
  ...
  <form id="theory"> <p> Find detailed and comprehensive course for developing your basic understanding of the subject.<br><br> Let&apos;s go!
         ...
         <li><a href="../Documents/SystemDevelopmentforSoftwareTheory.doc">Click here to download.</a></li>
         </form>
...
<br><br>Let&apos;s go! 
         ...
         <li><a href="../Documents/SystemDevelopmentforSoftwarePractical.doc">Click here to download.</a></li>
       </form> </div>
<?php   
     include('footer.php');
    ?>
